                        ...
                        <div class="product-carousel">
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="/res/site/img/products/<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Comprar</a>
                                        <a href="#" class="view-details-link"><i class="fa fa-link"></i> Detalhar</a>
                                    </div>
                                </div>
